...
<#assign xKeycloakify={
    ...
    "ftlTemplateFileName": "federatedIdentity.ftl",
    "themeType": "account",
    "themeName": "my-test-theme",
    "keycloakifyVersion": "11.3.19",
    "themeVersion": "1.0.0",
    "resourcesPath": ""
}>
...
<#function toJsDeclarationString object path>
    ...
    <#if isMethod>
        ...
        <#assign fieldNames = ["firstName", "lastName", "email", "username", "password", "password-confirm", "totp", "userLabel"]>
...
<#macro addNonAutomaticallyGatherableMessagesToXKeycloakifyMessages>
    ...
    <body>
        <div id="root"></div>
        <script type="module" src="${xKeycloakify.resourcesPath}/dist/src/index.tsx"></script>
